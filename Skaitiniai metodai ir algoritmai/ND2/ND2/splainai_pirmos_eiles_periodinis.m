function periodiniai_splainai
clc, close all, clear all
 
xmin=-2*pi; xmax=pi; n=7;
...
title(sprintf('Periodinis pirmos eiles defekto splainas. Parametrinis vaizdavimas'));
...
legend('Interpoliavimo koordinatës', 'F(X,Y)=0');
title(sprintf('Periodinio pirmos eilës defekto splaino interpoliavimas'));
return, end
